...
const styles = StyleSheet.create({
  ...
  // Stats and export buttons are always stacked (never siblings on the same
  // row) so buttonsContainer can never be vertically centered into whatever
  // horizontal space statsRow's wrapped cards happen to leave behind. That
  // used to happen at widths where statsRow wrapped its 3 cards onto their
  // own lines but the container was still in row mode.
  actionRowContainer: { gap: 14, marginBottom: 14 },
  ...
  buttonsContainer: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'flex-end', gap: 8 },
